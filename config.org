#+TITLE: Emacs Eats Dirt
#+AUTHOR: Ieatdirtdirt
#+DESCRIPTION: GNU Emacs config based off of Distrotube's configuring emacs series
...
#+end_src
* RAINBOW MODE
Display the actual color as a background for any hex color value (ex. #f0ffff).  The code block below enables rainbow-mode in all programming modes (prog-mode) as well as org-mode, which is why rainbow works in this document.  
